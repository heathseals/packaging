...
module Pkg::Params
  ...
  ENV_VARS = [{ :var => :apt_host,            :envvar => :APT_HOST },
              ...
              { :var => :signing_cert,        :envvar => :SIGNING_CERT },
              { :var => :signing_keychain,    :envvar => :SIGNING_KEYCHAIN },
              { :var => :signing_keychain_pw, :envvar => :SIGNING_KEYCHAIN_PW },
              { :var => :signing_server,      :envvar => :SIGNING_SERVER },
              { :var => :signing_ssh_key,     :envvar => :SIGNING_SSH_KEY },
